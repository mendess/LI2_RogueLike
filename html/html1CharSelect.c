...
void imprimeCharSelect(){
	...
	printf("<rect x=30 y=21 width=230 height=368 style=opacity:0;>\n");
	FECHAR_LINK;
	ABRIR_LINK("61");//Warrior
	printf("<rect x=285 y=21 width=230 height=368 style=opacity:0;>\n");
	FECHAR_LINK;
	ABRIR_LINK("63");//Mage
	printf("<rect x=540 y=21 width=230 height=368 style=opacity:0;>\n");
	FECHAR_LINK;
	ABRIR_LINK("0");//back
