...
roguel: jogo.o parser.o path.o estado.o score.o levelMaker.o move_monst.o colisions.o
	cc -o roguel jogo.o estado.o path.o parser.o score.o levelMaker.o move_monst.o colisions.o
