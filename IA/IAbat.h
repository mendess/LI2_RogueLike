...
@param e Estado do jogo
@param a matriz das interceções.
...
@param num numero que representa se o morcego deve intersectar o jogador a noroeste,nordeste,sudoeste ou sudeste
@return posição para a qual o morcego se vai mover
*/
...
@param num cada um dos 4 numeros simboliza se o monstro está a noroeste,nordeste,sudoeste ou sudeste do jogador.
@return estado depois do morcego se ter movido.
*/
