...
*/
/**
\brief Verifica se o arqueiro está entre o jogador e a saida e se a saida está nordeste do jogador
*/
#define BLOQUEAVEL_NE	e.jog.y>p.y && e.jog.x<p.x && p.x<e.saida.x && e.saida.y<p.y && e.saida.x>e.jog.x && e.saida.y<e.jog.y
/**
\brief Verifica se o arqueiro está entre o jogador e a saida e se a saida está noroeste do jogador
*/
#define BLOQUEAVEL_NO   e.jog.y>p.y && e.jog.x>p.x && e.saida.x<p.x && e.saida.y<p.y && e.saida.x<e.jog.x && e.saida.y<e.jog.y
/**
\brief Verifica se o arqueiro está entre o jogador e a saida e se a saida está sudeste do jogador
*/
#define BLOQUEAVEL_SE   e.jog.y<p.y && e.jog.x<p.x && e.saida.x<p.x && e.saida.y>p.y && e.saida.x<e.jog.x && e.saida.y>e.jog.y
/**
\brief Verifica se o arqueiro está entre o jogador e a saida e se a saida está sudoeste do jogador
*/
...
/**
\brief preenche uma matriz a[SIZE][SIZE] com o valor 50 que postriormente será usado para identificar pedras e monstros
@param a Matriz
*/
...
@returns estado do jogo depois do arqueiro se ter movido, desviado do jogador ou atacado o jogador.
*/
